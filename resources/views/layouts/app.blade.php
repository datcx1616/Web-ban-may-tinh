...
<body>
                            ...
                            @auth
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right"
                                        style="z-index:10001; border-radius: 10px;">
                                        @if ($user && $user->role === UserRole::ADMIN)
                                            <a href="{{ route('admin.home.index') }}" class="dropdown-item">Trang quản
                                                trị</a>
                                        @endif
        ...
        <div class="container-fluid bg-dark text-secondary">
            <div class="row px-xl-5 pt-5">
                <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    ...
                    <p class="mb-4 text-justify">Tại đây, bạn sẽ tìm thấy máy tính và các sản phẩm công nghệ liên quan
                        chất
                        lượng, đa dạng và đáng tin cậy. Hãy khám phá ngay!</p>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>182 Lê Duẩn, thành phố
                        Vinh,
                        Nghệ An</p>
                        ...
                        <div class="col-md-4 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                <a class="text-secondary mb-2" href="#"><i
                                    ...
                                    chủ</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Cửa
                                    hàng</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Giỏ
                                    hàng</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Bài
                                    viết</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Liên
                                    hệ</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Trung
                                    Tâm Trợ Giúp</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Hướng
                                    Dẫn Mua Hàng</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Trả
                                    Hàng & Hoàn Tiền</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Chính
                                    Sách Bảo Hành</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>Vận
                                    Chuyển</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-5">
    ...
    <script src="{{ asset('client/js/snow.js') }}"></script>
    <script>
