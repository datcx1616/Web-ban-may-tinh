                    ...
                    <tbody class="align-middle">
                        @forelse ($cart as $product)
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    @if ($isSale)
                                        <div class="sale-origin"><span class="text-line-through">{{ number_format($product->price) }}</span> VND</div>
                                    @endif
                                ...
                                <td class="align-middle">{{ number_format($priceShow * $product->quantity) }} VND</td>
